      ...
      <div class="row">
        <?php
          foreach ($rds as $rd)
          {
            ...
            ?>
            <div class="col-md-12">
              <div class="cnt-header" style="box-shadow: 0px 10px 10px rgba(0,0,0,.1);margin: 15px 0;background:white;padding:60px 20px;color:white">
    ...
    <div class="container">
      <div class="row">
          ...
          if ($checkhi > 0)
          {
           ...
           ?>
        <div class="col-md-12">
          <div class="cnt-header" style="box-shadow: 0px 10px 10px rgba(0,0,0,.1);margin: 0px 0;background:white;padding:60px 20px;color:white">
        ...
        <div class="col-md-12">
          <div class="cnt-header" style="box-shadow: 0px 10px 10px rgba(0,0,0,.1);margin: 20px 0;background:white;padding:60px 20px;color:white">
        ...
        $ehc = $stmt2->rowCount();
         ...
         ?>
           <div class="col-md-12" style="">
             <div class="fd " style="background:white;padding:40px !important;box-shadow: 0px 10px 10px rgba(0,0,0,.1);">
               <img src="<?php echo $images ?>mm.png" style="width:100%" alt="">
             </div>
             <div class="fd" style="padding:40px 0;text-align:center;background:white">
                ...
                <tbody>
                  ...
                  if ($ehc > 0)
                  {
                    ...
                    <?php
                        ...
                        {
                          ?>
                          <tr style="background:white;margin:20px 0;border-bottom:3px solid rgba(0,0,0,.3)">
                            <td>
                                  <?php echo $ad['id'] ?>
                            </td>
                            <td>
...
<?php
    ...
    elseif($page == 'store')
    {
      ...
      <section class="mpprre87 paymentmethod" style="margin:150px  0;margin-bottom:40px">
        <div class="container">
            ...
            <div class="col-md-9">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="paytpye" style=";background:white;padding:14px;text-align:center;font-size:18px">
      ...
      <div class="content dash-content ptszone" style="margin-bottom:300px">
        <div class="dashboard lf-pd" id="dashboard">
          <div class="container">
            <div class="row ">
                                                                                         ...
                                                                                         <div class="col-md-6">
                                                                                           <a href="paymentSelect.php?page=ad&id=<?php echo $option['id'] ?>">
                                                                                             <div class="cashbox ds " style="padding:15px;background:white;margin:10px 0">
                                                                                               <div class="row">
                                                                                                 <div class="col-md-4">
                                                                                                   <img src="<?php echo $images ?>out.png" style="width:96%" alt="">
                                                                                                 </div>
                                                                                                 <div class="col-md-8">
                                                                                                   <div class="today-total" style="text-align:left;padding:0 !important">
...
<div class="form-row justify-content-center">
  ...
  <div class="col-md-7">
            ...
            <h1 style="padding:15px;display:block;text-align:center;text-transform:capitalize;background:white;box-shadow: 0px 5px 5px rgba(0,0,0,.1);">Personal Data</h1>
  ...
  <div class="form-group col-md-6">
    ...
    <input type="datetime-local" name="br" class="form-control"    value="<?php  echo $userInfo['zip'] ?>" >
        ...
        <div class="col-md-7">
                  ...
                  <h1 style="box-shadow: 0px 5px 5px rgba(0,0,0,.1);padding:15px;display:block;text-align:center;text-transform:capitalize;background:white">Security Data</h1>
