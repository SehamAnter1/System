                    ...
                    <div class="col-sm-9">
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          <a id="on" class="btn btn-outline-secondary" style="height:unset !important;border:1px solid rgba(0,0,0,.1);color:white"  type="button" >on</a>
                          <a id="off" class="btn btn-outline-secondary" style="height:unset !important;border:1px solid rgba(0,0,0,.1);color:white"  type="button" >off</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          ...
                          <a id="off2" class="btn btn-outline-secondary" style="height:unset !important;border:1px solid rgba(0,0,0,.1);color:white"  type="button" >off</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group row">
                    <div class="col-sm-9 col-xs-12">
                      <input  type="button"  class="btn btn-primary" id="mbeadbtn99003f3svb" value="submit">
                    </div>
                  </div>
        ...
        <div class="col-md-4">
          <div class="login">
            ...
            <form class="#" action="" method="post" style="text-align:left;width:90%;padding-bottom:153px" id="sforgotpasspage">
              ...
              <div class="form-group">
                <input id=""  type="button"  class="btn btn-primary" value="confirm" style="text-transform: capitalize;border:none;width:60%;text-align:center !important;text-transform:capitalize;margin:auto !important">
        ...
        <div class="col-md-5">
          <div class="login">
            ...
            <form class="#" action="" method="post" style="text-align:center;width:90%" id="registerform">
              ...
              <div class="form-group">
                <input onclick="validateform()" id="registerbtn"  type="button"  class="btn btn-primary" value="register" style="text-transform: capitalize;border:none;width:60%;text-align:center !important;text-transform:capitalize;margin:auto !important">
        ...
        <div class="col-md-5">
          <div class="login" style="border-radius:5px 0px 0px 5px !important">
            ...
            <form class="#" action="" method="post" style="text-align:center;" id="loginform">
              ...
              <div class="form-group">
                <input  type="button"  class="btn btn-primary" id="login_botton" value="sign in" style="text-transform: capitalize;border:none;width:60%;text-align:center !important;text-transform:capitalize;margin:auto !important">
