  ...
  if (isset($_SESSION['clientid']))
  {
    $page = isset($_GET['page']) ? $_GET['page'] : 'login';
      ...
      if ($page == 'ad')
      {
        ...
        ?>
        <section class="paymentmethod" style="margin:150px  0;margin-bottom:40px">
          <div class="container">
        ...
        include 'init.php';
          ...
          <section class="subs col-10" style="background:#F5F5F5; ">
            <div class="container">
              ...
              <input class="form-check-input prpmmf"  type="radio" level="0" name="flexRadioDefault" id="flexRadioDefault2" checked>
              <label class="form-check-label" for="flexRadioDefault2 " style="color:white">
                Starter
              </label>
                      <span style="color:white">$7.75 <small>/mo</small> </span>
            </div>
              ...
              <input class="form-check-input prpmmf"  type="radio" level="1" name="flexRadioDefault" id="flexRadioDefault2" checked>
              ...
              STANDERED
                      ...
                      <li>
                        <div class="form-check">
              <input class="form-check-input prpmmf"  type="radio" level="2" name="flexRadioDefault" id="flexRadioDefault2" checked>
              <label class="form-check-label" for="flexRadioDefault2">
              PREMIUM
              </label>
                      ...
                      <li  >
                        <div class="form-check">
              <input class="form-check-input prpmmf"  type="radio" level="3" name="flexRadioDefault" id="flexRadioDefault2" checked>
              <label class="form-check-label" for="flexRadioDefault2">
                UNLIMITED
              </label>
